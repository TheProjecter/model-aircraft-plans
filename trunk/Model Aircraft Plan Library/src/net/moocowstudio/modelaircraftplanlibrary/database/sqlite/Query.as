package net.moocowstudio.modelaircraftplanlibrary.database.sqlite {
    import flash.data.*;
    import flash.events.*;
    ...
    public class Query extends EventDispatcher {
        ...
        [Bindable] public function get connection() : SQLConnection {
            return _connection;
        }
        ...
        [Bindable] public function get sql() : String {
            return _sql;
        }
        ...
        [Bindable] public function get parameters() : Array {
            return _parameters;
        }
        ...
        [Bindable] public function get data() : Array {
            return _data;
        }
